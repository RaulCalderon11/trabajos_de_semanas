 ...
 * @author USUARIO
 */
public class CalculadoraSalario extends javax.swing.JFrame {

    /**
     * Creates new form CalculadoraSalario
     */
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Tarifas hoararias ");

        jLabel4.setText("Numeroa de hijos");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtHorasTrabajadas, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel4)
                    .addComponent(txtTarifaHoraria, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel3)
                    .addComponent(txtNumeroHijos, javax.swing.GroupLayout.PREFERRED_SIZE, 74, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(90, 90, 90))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(9, 9, 9)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtTarifaHoraria, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnProcesarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcesarActionPerformed
        ...
        // 2. Realizar los cálculos según las reglas del documento
        double sueldoBruto = horas * tarifa;
    
        // El bono es 5% del sueldo bruto por cada hijo 
        double bonificacion = (sueldoBruto * 0.05) * hijos;
    
        double sueldoNeto = sueldoBruto + bonificacion;

        // 3. Mostrar los resultados en el área de texto
        // Usamos el carácter '\n' para crear saltos de línea
        String reporte = "=========== REPORTE ===========" +
                     "Empleado: " + empleado + " " +
                     "Horas trabajadas: " + horas + " " +
                     "Tarifa horaria: S/ " + String.format(" ", tarifa) + " " +
    ...
    // Colocamos el cursor de nuevo en el primer campo
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalculadoraSalario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CalculadoraSalario().setVisible(true);
            }
        });
    }
